...
public class SoftAssertion {
	...
	public void invalidLoginError() throws InterruptedException {
		...
		driver.findElement(By.id("txtPassword")).sendKeys("Hum@nhrm12356");
		driver.findElement(By.id("btnLogin")).click();
		
		SoftAssert softAssertion = new SoftAssert();
		String expectedErrorMessage1="Invalid credentials";
		...
		String errorMessage2= "Password cannot be empty";
